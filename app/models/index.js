...
db.uploadedEvents = require("./event/uploaded_events.model")(
  sequelize,
  Sequelize
);
db.registeredEvents = require("./event/registered_events.model")(
  sequelize,
  Sequelize
);
db.masterEventCategory = require("./master/master_categories.model")(
  sequelize,
  Sequelize
);
db.masterRatingType = require("./master/master_rating_types.model")(
  sequelize,
  Sequelize
);
...
db.articlesDB = require("./articles.model")(sequelize, Sequelize);
